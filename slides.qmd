...
# Agenda {style="text-align:center;"}
-   Introduction
-   Method
-   Example
-   Application
...
::: {.column width="40%"}
- Distance measures quality of variables.
:::
...
::: {.column width="50%"}
![](docs\analysis_files\figure-html\unnamed-chunk-25-2.png)
:::

::::
<!-- --Slide-- -->
# Uncorrelations {style="text-align:center;"}

![8 Uncorrelations Principal Components](docs/analysis_files/figure-html/unnamed-chunk-30-1.png){width="50%" fig-align="center"}


<!-- # Uncorrelations {style="text-align:center;"} -->
<!-- ![](docs\analysis_files\figure-html\unnamed-chunk-30-1.png) {width="50%"; fig-align="center"} -->
