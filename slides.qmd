...
-   The eigenvectors of $S$ are the solutions to finding the $Xa_k$ which maximize variance while minimizing correlation.
...
-   The vector length represents the projection of the original observations onto the PCs.
...
# References {.scrollable style="font-size:15px"}
