...
-   Ideally, variables are similar in scale and free from extreme outliers.
...
-   'Inherent components' of the covariance matrix which contain the most information.
...
$$
-   Covariance Matrix: Square matrix which gives the covariance values of each pair of variables in the dataset.
:::

# Finding the Principal Components
::: {.panel-tabset style="font-size: 85%;"}
### Basis
-   Find the linear combination of the columns of $X$ which maximizes variance.
...
-   $Xa_k$ are the principal components of the dataset with eigenvectors $a_k$ and eigenvalues $\lambda_k$.
:::
